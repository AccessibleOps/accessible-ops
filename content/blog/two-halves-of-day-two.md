...
description: "The onboarding test runs on day one and every day after. Day two is authoring and applying, and the properties test both."
---
...
Accessible Ops is the test for both. The synthesis properties ask whether the stranger can predict the spec before it runs. The lifecycle properties ask whether the risky change stops for a human and the reversible one goes through.
